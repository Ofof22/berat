...
.setColor('RED')
.setTitle('**Hata! ⚠️**')
.setDescription('**b!kredi** komutu bölümlere ayrılır,Mesela para yatırmak istiyorsanız; \n **b!kredi yatır <tutar>** şeklinde olmalı.Mesela para çekmek istiyorsunuz; \n **b!kredi çek <tutar>** şeklinde olmalı.')
