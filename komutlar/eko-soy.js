...
\`\`\`Bilgi;\`\`\`
**⭐ Ak47 ile Banka soyarsınız almak için (b!blackmarket ak47)
⭐ Uzi ile Kuyumcu soyarsınız almak için (b!blackmarket uzi)
⭐Pistol ile Market soyarsınız almak için (b!blackmarket pistol)
⭐Bıçak ile adam bıçaklarsınız almak için (b!blackmarket bıçak)**
*Örnek: b!soy adam @Kullanıcı*
`
      );
  /*global client*/
