...
.setDescription(`
Bir mob belirtiniz. Örnek: \n b!zindan zombi/örümcek/iskelet/creeper/enderman
`)
...
if(args[0] === "örümcek") {
  if(!elmaskılıç) return message.reply(`Hiç elmas kılıcınız bulunmamaktadır! b!market`)
...
if(args[0] === "creeper") {
      if(!demirkılıç) return message.reply(`Hiç taş baltanız bulunmamaktadır! b!market`)
...
`)
      ...
      if(args[0] === "enderman") {
    if(!demirkılıç) return message.reply(`Hiç demir kılıcınız bulunmamaktadır! b!market`)
